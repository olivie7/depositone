...
if(!empty($_POST)){
	...
	if(count($errors) === 0)
	{
		$insert = $bdd->prepare('INSERT INTO users (lastname, firstname, password, email, phone, street, zipcode, city) VALUES (:lastname, :firstname, :password, :email, :phone, :street, :zipcode, :city)');
